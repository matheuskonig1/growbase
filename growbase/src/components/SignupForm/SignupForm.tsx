              ...
              <form className='text-center'>
                <img className="mb-4" src="https://shiny-buttercream-377ac5.netlify.app/main-menu.png" alt="" width="72"/>
                  ...
                  <div className="form-floating">
                    <input type="email" className="form-control bg-transparent text-white" id="floatingInput" placeholder="email@example.com" name="email"/>
                    <label className="text-white" htmlFor="floatingInput">Insira seu e-mail</label>
                  </div>
                  <div className="form-floating">
                    <input type="password" className="form-control bg-transparent text-white" id="floatingPassword" placeholder="Senha" name="password"/>
                    <label className="text-white" htmlFor="floatingPassword">Insira sua senha</label>
                  </div>
                  <div className="form-floating ">
                    <input type="password" className="form-control bg-transparent text-white" id="floatingCPassword" placeholder="Senha" name="rpassword"/>
                    <label className="text-white" htmlFor="floatingCPassword">Confirme sua senha</label>
                  </div>
                  <a className="w-100 btn btn-lg btn-light mb-3" type="submit">Criar conta</a>
