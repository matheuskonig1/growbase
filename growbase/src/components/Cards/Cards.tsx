    ...
    return (
        <>
            <div className="container px-4 py-5" id="featured-3">
                <h2 className="pb-2 text-light display-4">Por que usar o <span className="yellow">{environment.PRODUCT_NAME}</span>?</h2>
                    <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
                        ...
                        <h2 className="text-white display-6">Organize a vida.</h2>
                    ...
                    <div className="feature col">
                        ...
                        <h2 className="text-white display-6 justify-content-end aligh-items-end">Deixe um recado.</h2>
